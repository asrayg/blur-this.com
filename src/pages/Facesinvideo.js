// src/components/FacesInVideo.js
...
const FacesInVideo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/blur-faces", formData, {
        headers: {
  ...
  return (
    <div className="gradient-background">
      <div className="container">
        <h2>Blur Faces in Video</h2>
        <p>
          This tool uses advanced computer vision techniques to detect and blur faces in video files. By leveraging
