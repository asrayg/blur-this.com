...
const FacesInPics = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://localhost:5000/blur-faces-in-pictures", formData, {
        headers: {
  ...
  return (
    <div className="gradient-background">
      <div className="container">
        <h2>Blur Faces in Pictures</h2>
        <p>
          This tool uses advanced computer vision techniques to detect and blur faces in images. By leveraging
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <button type="submit">Blur Faces</button>
          </div>
        </form>
        {previewUrl && (
